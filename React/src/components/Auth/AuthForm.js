...
const AuthForm = (props) => {
    ...
    const submitHandler = (e) => {
        ...
        if (isLogin) {
            url =
                `http://localhost/React-PHP/PHP/auth/login.php`;
        } else {
            url =
                'http://localhost/React-PHP/PHP/auth/register.php';
        }
        fetch(url, {
            method: 'POST',
            body: JSON.stringify({
    ...
    const submitPasswordHandler = (e) => {
        ...
        fetch('http://localhost/React-PHP/PHP/auth/newpassword.php', {
            method: 'POST',
            body: JSON.stringify({
                    ...
                    <div className={classes['login-container']}>
                        <form onSubmit={submitHandler} >
                            ...
                            <div className={emailClasses}>
                                <input type='text' placeholder='Enter Email' ref={emailInputRef} onChange={emailChangeHandler} onBlur={emailBlurHandler} />
                            </div>
                ...
                <div className={classes.login} >
                    <div className={classes['login-container']}>
                        <form onSubmit={submitPasswordHandler} >
                            ...
                            <div className={passwordClasses}>
                                <input type='password' placeholder='Enter current password' ref={currentPassword} onChange={passwordChangeHandler} onBlur={passwordBlurHandler} />
                            </div>
                            <div className={passwordClasses}>
